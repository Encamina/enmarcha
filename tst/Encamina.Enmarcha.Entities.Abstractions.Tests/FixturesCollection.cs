...
/// <summary>
/// <para>
///     Base class used to decorate test classes and collections to indicate a test which has per-test-collection fixture data.
/// </para>
/// <para>
...
/// </summary>
/// <remarks>
/// <b>Fixture classes can be shared across assemblies, but fixture collection definitions cannot and must be in the same assembly
/// as the test that uses them, othertwise they will not work</b>.
/// </remarks>
