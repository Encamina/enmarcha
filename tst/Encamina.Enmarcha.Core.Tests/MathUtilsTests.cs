...
public class MathUtilsTests
{
    ...
    public void Calculate_Percentile_Succeeds(double[] values, double percentile, double expected)
    {
    ...
    public void Calculate_StandardDeviation_Succeeds(double[] values, double expected)
    {
