...
- Added `SkVisionImageDocumentConnector` which allows to read images and extract text from them. Using Semantic Kernel vision capabilities. It does not process images larger than 8192px in width or height, nor images with more text than the number of output tokens of the model used.
