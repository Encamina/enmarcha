...
public interface IGreetingsProvider
{
    ...
    /// before <see cref="SendAsync"/> to add any template properties that should be considered as tokens for the greetings
    /// message.
    /// </summary>
    /// <param name="templateProperties">
    /// A dictionary with values to use as replacements for tokens or parameters in the greetings message.
    /// </param>
