...
/// <summary>
/// <see cref="ILoggerProvider"/> implementation that creates returns instances of <see cref="ApplicationInsigthsConversationScopedLoggerProvider"/>.
/// </summary>
public class ApplicationInsigthsConversationScopedLoggerProvider : ILoggerProvider, ISupportExternalScope
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ApplicationInsigthsConversationScopedLoggerProvider"/> class.
    /// </summary>
    ...
    public ApplicationInsigthsConversationScopedLoggerProvider(IOptions<TelemetryConfiguration> telemetryConfigurationOptions, IOptions<ApplicationInsightsConversationScopedLoggerOptions> applicationInsightsLoggerOptions, IHttpContextAccessor httpContextAccessor)
    {
        ...
        telemetryClient.Context.GetInternalContext().SdkVersion = SdkVersionUtils.GetSdkVersion("il:", Assembly.GetAssembly(typeof(ApplicationInsigthsConversationScopedLoggerProvider)));
    }
    ...
    {
        return new ApplicationInsigthsConversationScopedLogger(categoryName, telemetryClient, applicationInsightsLoggerOptions, httpContextAccessor)
        {
