...
/// </summary>
internal sealed class ApplicationInsightsConversationScopedLogger : ILogger
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ApplicationInsightsConversationScopedLogger"/> class.
    /// </summary>
    ...
    public ApplicationInsightsConversationScopedLogger(string categoryName, TelemetryClient telemetryClient, ApplicationInsightsConversationScopedLoggerOptions applicationInsightsLoggerOptions, IHttpContextAccessor httpContextAccessor)
    {
    ...
    private void PopulateTelemetry<TState>(ISupportProperties telemetryItem, TState state, EventId eventId)
    {
        ...
        var activity = httpContextAccessor.HttpContext?.Request?.GetActivityAsync()?.Result;
