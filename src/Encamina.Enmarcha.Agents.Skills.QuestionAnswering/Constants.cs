...
{
    /// <summary>
    /// Default intent for the question answering dialog that can be obtained from <see cref="QuestionAnsweringDialog.Intent"/>.
    /// </summary>
    ...
    /// <summary>
    /// Label for a parameter that can be sent (usually as a JSON payload) in an <see cref="Activity.Value"/> to request verbose tracing from this skill.
    /// </summary>
