...
public static class IServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Adds a default implementation of <see cref="IDocumentContentEnrichedExtractor"/> to the specified <see cref="IServiceCollection"/> as a singleton service.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> to add services to.</param>
    /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
    public static IServiceCollection AddDefaultDocumentContentEnrichedExtractor(this IServiceCollection services)
    {
        return services.AddScoped<IDocumentContentEnrichedExtractor, DefaultDocumentContentEnrichedExtractor>();
    }
    ...
    /// <param name="lengthFunction">A length function to use when extracting content from documents.</param>
    /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
    public static IServiceCollection AddDefaultDocumentContentEnrichedExtractor(this IServiceCollection services, Func<string, int> lengthFunction)
    {
        services.AddSingleton(lengthFunction);
        return services.AddDefaultDocumentContentEnrichedExtractor();
    }
    ...
    /// <param name="services">The <see cref="IServiceCollection"/> to add services to.</param>
    /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
    public static IServiceCollection AddDefaultDocumentConnectorEnrichedProvider(this IServiceCollection services)
    {
        return services.AddScoped<IDocumentConnectorProvider, DefaultDocumentContentEnrichedExtractor>();
    }
